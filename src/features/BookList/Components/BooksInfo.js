...
const product = {
  ...
  description:
    "picture",
  details:
    "It's no longer than 200 words and usually contains a hook, the most important detail from its author's biography, and the main selling point. The book description goes more into the book's content, giving readers the central plot line without spoiling it.",
}
      ...
      <div className="pt-6">
        ...
        <div className="mx-auto  px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div className="mt-10">
              <h2 className="text-sm font-medium text-gray-900"> BooksDetails</h2>
